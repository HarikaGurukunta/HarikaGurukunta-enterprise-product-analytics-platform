...
customers = pd.DataFrame({
    ...
    "city": np.random.choice(["New York", "Chicago", "Dallas", "Los Angeles"], 1000),
    "signup_date": pd.date_range(start="2023-01-01", periods=1000, freq="D")
})
...
orders = pd.DataFrame({
    ...
    "order_date": pd.to_datetime(
        np.random.choice(pd.date_range("2023-01-01", "2025-12-31"), 10000)
    ),
...
print("Customer, product, and order data generated successfully!")
